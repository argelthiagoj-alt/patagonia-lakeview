 ...
 * Anything that touches cookies / DB lives in `@/modules/auth/session`.
 *
 * Lives in `src/shared/` because it is consumed across every module
 * (auth, reservations, admin pages, header UI) without owning a domain.
 */
